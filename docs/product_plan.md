...
- Use clear timing in metrics: YTD, last 4 weeks, or explicit date range.
...
- Map coloring modes: Permit Scope, Well Type, Operator, Date.
...
- Work groups:
  - New Drills: New Drill
  - Reentries: Deepen, Sidetrack, Rework
  - Injection: injection, disposal, waterflood, steamflood, gas disposal, pressure maintenance well types
  - Abandonments: Abandon, Re-Abandon
